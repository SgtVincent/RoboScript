...
class GraspExecutor:
    ...
    def computeIK(self, orientation, position, ik_link_name = "panda_hand_tcp", move_group="panda_manipulator") -> bool:
...
grasp_controller = GraspExecutor("panda_link0", load_wall=False, reset_pose = [-0.39999520574177366, 0.4740489757251173, -0.5709029256494976, -1.1338590764153493, 0.7967397934201639, 1.0726936823311086, -1.427030496828192])
print("Resetted")
